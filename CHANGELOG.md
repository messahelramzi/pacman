...
## [0.1.0] - 2026-05-29 (Initial release of the package)
...
- Core algorithm libraries (rbfpum, finiteelements) are header-only Kokkos/C++ template libraries requiring C++20 and Kokkos ≥ 5.0 / KokkosKernels ≥ 5.0 / ArborX ≥ 2.0.
