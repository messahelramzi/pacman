...
- Python bindings (enabled via -DBUILD_PYTHON_INTERFACE=ON, default ON) via pybind11 for both FE and RBF-PUM interpolation APIs, also built with ETI for each execution space.
