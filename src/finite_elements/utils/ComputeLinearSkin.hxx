...
/**
 * This file is part of the Field Transfer process. It handles the creation of
 * the skin of the mesh. Skin here should be understood as the faces of the mesh
 * that are not shared by 2 distinct elements. The term "face" refers to the d -
 * 1 base elements (3D: triangle, 2D: bars, 1D: points).
 */
...
/**
 * @brief Compute linear skin algorithm, fills transfer->skinFaces and
