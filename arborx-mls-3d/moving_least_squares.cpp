...
{
  return Kokkos::cos((p[0] + p[1] + p[2]) / 4);
}
...
int main(int argc, char *argv[])
{
  ...
  Kokkos::parallel_for(
      ...
      KOKKOS_LAMBDA(int const) {
        for (int i = 0; i < 3; i++) { // We must add more source points
          src_points(0 + i * 9) = {0., 0., (double)(i % 3)};
          src_points(1 + i * 9) = {1., 0., (double)(i % 3)};
          src_points(2 + i * 9) = {2., 0., (double)(i % 3)};
          src_points(3 + i * 9) = {0., 1., (double)(i % 3)};
          src_points(4 + i * 9) = {1., 1., (double)(i % 3)};
          src_points(5 + i * 9) = {2., 1., (double)(i % 3)};
          src_points(6 + i * 9) = {0., 2., (double)(i % 3)};
          src_points(7 + i * 9) = {1., 2., (double)(i % 3)};
          src_points(8 + i * 9) = {2., 2., (double)(i % 3)};
        }

        tgt_points(0) = {4. / 6., 4. / 3., 0.};
        tgt_points(1) = {9. / 6., 3. / 3., 1.};
        tgt_points(2) = {2. / 6., 1. / 3., 2.};
      });
